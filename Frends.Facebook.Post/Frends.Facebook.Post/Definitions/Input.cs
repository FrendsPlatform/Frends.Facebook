namespace Frends.Facebook.Post.Definitions;
...
public class Input
{
    ...
    /// Gets or sets data.
    /// </summary>
    /// <example>{"data": [{"created_time": "2019-01-02T18:31:28+0000", "message": "This is my test post on my Page.", "id": "page_post_id"}], ...}</example>
    [DisplayFormat(DataFormatString = "Text")]
    [DefaultValue("{\"data\": {}}")]
